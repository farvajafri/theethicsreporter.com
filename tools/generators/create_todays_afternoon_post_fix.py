...
valid_ids = [post.get('id', 0) for post in posts if isinstance(post.get('id'), int)]
...
subprocess.run(f"cp /Users/farvascott/code/theethicsreporter/theethicsreporter.com/public/images/posts/courts-weaponizing-sanctions-gatekeep-ai-2026.jpg {img_dir}/{slug}.jpg 2>/dev/null || touch {img_dir}/{slug}.jpg", shell=True)
