...
IMG_DIR = f"{REPO}/theethicsreporter.com/public/images/posts"
...
def main():
    ...
    deploy = subprocess.run(["vercel", "--prod", "--yes"], cwd=f"{REPO}/theethicsreporter.com", capture_output=True, text=True, timeout=300)
