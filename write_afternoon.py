...
<ul>
<li><strong>The Enforcement Surge:</strong> In the first quarter of 2026 alone, U.S. courts imposed over $145,000 in sanctions against attorneys for AI-related "hallucinations" and filing errors.</li>
...
<li><strong>Recent Casualties:</strong> In February 2026, the 5th U.S. Circuit Court of Appeals sanctioned attorney Heather Hersh $2,500 specifically for using AI to draft a brief containing fabricated citations, signaling a massive escalation by appellate courts.</li>
...
<p>But transparency would require acknowledging that the traditional model of lawyering is obsolete. It would require admitting that a machine can do in seconds what a human does in hours, and that charging clients for the latter is essentially extortion. The legal profession is not ready for that conversation. So instead, they sanction Heather Hersh. They fine the early adopters. They make examples of the careless to terrify the curious.</p>
