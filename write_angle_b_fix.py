...
slug = 'law-schools-scam-declining-value-ai-era-2026'
...
new_post = {
    ...
    'content': content,
    'excerpt': excerpt,
    'link': f'https://theethicsreporter.com/2026/04/23/{slug}/',
    'status': 'publish',
    'featured_image': f'/images/posts/law-schools.jpg',
    'categories': [1, 2],
